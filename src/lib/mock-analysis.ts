...
function scaleMicronutrients(micronutrients: Micronutrients, multiplier: number): Micronutrients {
  return {
    ...
    magnesiumMg: roundToSingleDecimal(micronutrients.magnesiumMg * multiplier),
    ironMg: roundToSingleDecimal(micronutrients.ironMg * multiplier),
    zincMg: roundToSingleDecimal(micronutrients.zincMg * multiplier),
    omega3Mg: roundToSingleDecimal(micronutrients.omega3Mg * multiplier),
...
function addMicronutrients(
  ...
  return {
    ...
    magnesiumMg: roundToSingleDecimal(current.magnesiumMg + addition.magnesiumMg),
    ironMg: roundToSingleDecimal(current.ironMg + addition.ironMg),
    zincMg: roundToSingleDecimal(current.zincMg + addition.zincMg),
    omega3Mg: roundToSingleDecimal(current.omega3Mg + addition.omega3Mg),
...
export function createMockMealAnalysis(input: {
  ...
  return normalizeAnalysis({
    ...
    micronutrients: {
      ...
      magnesium_mg: totals.micronutrients.magnesiumMg,
      iron_mg: totals.micronutrients.ironMg,
      zinc_mg: totals.micronutrients.zincMg,
      omega3_mg: totals.micronutrients.omega3Mg,
