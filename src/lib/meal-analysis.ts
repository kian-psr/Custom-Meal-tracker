...
function buildPrompt(input: AnalyzeMealInput) {
  return [
    ...
    "Estimate calories, macros, and best-effort micronutrients for the meal, including magnesium, zinc, and omega-3 when relevant.",
    ...
    "Make sure the component breakdown covers the full meal and adds up closely to the total calories and macros you return.",
  ].join(" ");
}
